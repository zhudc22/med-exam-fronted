...
const QsnTable = ({ loading, tableName, data }: { loading: boolean; tableName: string; data: API.StatsBoardTotal[]; }) => (
	<Card
		loading={loading}
	...
	>
		...
		<div style={{ textAlign: "center", fontWeight:"bolder" }}>（注：不合格人数包含高低肩和翼状肩胛等异常情况；且一个人存在多种异常体态）</div>
	</Card>
);

export default QsnTable;
